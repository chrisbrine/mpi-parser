...
export type ValidatorFn = (args: FunctionArgs[], expectedTypes: string[], functionName: string) => void;
...
export type FunctionHandlerOverlap = (params: FunctionHandlerOverlapArgs) => FunctionHandler;
